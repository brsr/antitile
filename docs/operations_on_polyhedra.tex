...
\foreach \x in {1,3,5,7,9} {
  \draw (\x,-1) arc [radius=1.4142, start angle=45, end angle= 135];
  \draw (\x,1) arc [radius=1.4142, start angle=-45, end angle= -135];
}
\foreach \x in {-1,1,3,5,7,9} {
  \draw (\x,-1) arc [radius=1.4142, start angle=135, end angle= 180];
  \draw (\x,-1) arc [radius=1.4142, start angle=45, end angle= 0];
  \draw (\x,1) arc [radius=1.4142, start angle=-45, end angle= 0];
  \draw (\x,1) arc [radius=1.4142, start angle=225, end angle= 180];
}
\draw (-1,1) arc [radius=1.4142, start angle=45, end angle= -45];
\draw (-1,1) arc [radius=1.4142, start angle=-45, end angle= -90];
\draw (9,1) arc [radius=1.4142, start angle=135, end angle= 225];
\draw (9,1) arc [radius=1.4142, start angle=-135, end angle= -90];
\draw (-1,-1) arc [radius=1.4142, start angle=45, end angle= 90];
\draw (-1,-1) arc [radius=1.4142, start angle=-45, end angle= -90];
\draw (9,-1) arc [radius=1.4142, start angle=135, end angle= 90];
\draw (9,-1) arc [radius=1.4142, start angle=-135, end angle= -90];
...
\begin{tikzpicture}
  \pic at (0,0) {chamber4};
\draw (1,0) -- (0.5,0.5) -- (0.5,1.5) -- (1,2) -- (1.5,1.5) -- (1.5,0.5)
  -- (1,0);
\draw[fill] (0.5,0.5) circle [radius=0.05];
\draw[fill] (1.5,1.5) circle [radius=0.05];
\draw[fill] (1.5,0.5) circle [radius=0.05];
...
\begin{table}[h]%verify that the orientation is the same as in wythoff
...
\bibitem{grunbaum1} Branko Grunbaum. Are Your Polyhedra the Same as My
  ...
  pp 461-488
\bibitem{grunbaum2} Branko Grunbaum. Acoptic Polyhedra. Advances in Discrete
...
\bibitem{arp} Peter McMullen, Egon Schulte. Abstract Regular Polytopes,
  Encyclopedia of Mathematics and Its Applications Volume 92.
  Cambridge University Press, 2002
\bibitem{antiprism} http://www.antiprism.com/
\bibitem{brinkmann} Brinkmann, G.; Goetschalckx, P.; Schein, S. (2017).
...
\bibitem{Deza2004} M. Deza and M. Dutour. Goldberg-Coxeter constructions for 3-
   and 4-valent plane graphs. The Electronic Journal of Combinatorics,
   11, 2004. R20.
\bibitem{Goldberg} Goldberg, M, 1937. A class of multi-symmetric polyhedra.
    Tohoku Mathematical Journal.
\bibitem{Caspar} D.L.D. Caspar and A. Klug. Physical principles in the
  construction of regular viruses. In Cold Spring Harb Symp Quant Biol.,
  volume 27, pages 1–24, 1962.
\bibitem{Coxeter} H.S.M. Coxeter. Virus macromolecules and geodesic domes.
  In J.C. Butcher, editor, A spectrum of mathematics, pages 98–107.
  Oxford University Press, 1971.
\bibitem{Coxeter8} H.S.M. Coxeter. Truncation. In Regular Polytopes, 3rd ed, Dover, 1973.
\bibitem{HartPropeller} Hart, G. W. (2000) Sculpture Based on Propellorized
...
\bibitem{HartConway} Hart, G. W. Conway Notation for Polyhedra.
